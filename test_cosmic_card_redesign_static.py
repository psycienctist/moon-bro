...
assert 'with st.popover(trade_label, help="Find a member or send a card-trade request")' in source
...
assert 'CARD_MODULE_VERSION = "trade_acceptance_notification_v1"' in source
