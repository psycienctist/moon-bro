...
def render_collectible_card(card: dict):
    ...
    # --- CLICKABLE TERM TOGGLES (MOBILE-FRIENDLY) ---
...
# --- [REST OF FILE REMAINS IDENTICAL: list_users, send_trade, list_trades, resolve_trade, friends_of, render_profile_form, render_cosmic_cards_tab] ---
# (I have omitted the helper functions below for token efficiency, but they remain exactly as they were in your previous file).