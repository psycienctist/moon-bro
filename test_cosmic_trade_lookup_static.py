...
assert 'CARD_MODULE_VERSION = "trade_profile_lookup_v1"' in card_source
...
assert 'with st.popover("🤝 Trade Cards", help="Find a member or send a card-trade request")' in card_source
